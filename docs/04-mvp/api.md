...
>
> 문서 버전 v1.25 · 2026-09-08 · HTML 파생본: [api.html](../html/api.html)
>
...
| EP-SPEC-22 | `GET /api/v1/projects/{proj}/attachments/{id}` | 전 역할(`spec:read`) | — | 파일 본문 — 내려받기는 `CSP: sandbox` + `nosniff` 를 건다(`text/html` 만 `allow-scripts` · REQ-API-070) | — |
