...
>
> 문서 버전 v1.43 · 2026-09-24 · HTML 파생본: [api.html](../html/api.html)
>
...
| EP-APR-05 | `GET /api/v1/projects/{proj}/inbox` | 로그인 사용자(본인 관련만) — **사람 전용**(REQ-API-123 — 전역 EP-APR-01 과 같은 규칙) | — | 그 프로젝트의 받은 요청(결재 + 질문) — S7 이 프로젝트 안에서 읽는 곳 | — |
