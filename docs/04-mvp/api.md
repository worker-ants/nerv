...
>
> 문서 버전 v1.70 · 2026-09-26 · HTML 파생본: [api.html](../html/api.html)
>
...
| ID | 메서드 · 경로 | 권한 | 요청 | 응답 | 발생 이벤트 |
| --- | --- | --- | --- | --- | --- |
| EP-REQ-01 | `GET /api/v1/projects/{proj}/requirements` | 전 역할 | `RequirementListQuery`(spec, impl_status — **커서 없음**. 전표가 그 사실을 적어 두고 같은 괄호에 `cursor` 를 함께 적고 있었다) | `Page<RequirementResult>`(`ref`·`statement_md`·`impl_status`·연결 Task/Evidence 수) | — |
