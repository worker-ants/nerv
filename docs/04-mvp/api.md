...
>
> 문서 버전 v1.68 · 2026-09-26 · HTML 파생본: [api.html](../html/api.html)
>
...
// gate_policy — 전 키 선택(생략 시 기본값). version은 스키마 마이그레이션용
{
  ...
  "spec_gate": {
    ...
    "dynamic_escalation": true         // 티어 +1 — 지금 세는 신호는 첫 승인 버전 하나 (spec-workflow §2.4 "동적 강화")
  },
  "failopen": {
