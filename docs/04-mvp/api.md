...
>
> 문서 버전 v0.66 · 2026-09-04 · HTML 판: [api.html](../html/api.html)
>
...
| ID | 수용 기준(EARS) |
| --- | --- |
| REQ-API-069 | WHEN 스펙에 파일을 첨부하면 THE SYSTEM SHALL 형식 화이트리스트(png·jpeg·gif·webp·svg·pdf)와 파일당 10MB 를 강제하고, 올린 주체가 사람인지 에이전트인지 함께 기록한다 |
