...
>
> 문서 버전 v0.19 · 2026-09-05 · HTML 파생본: [scope.html](../html/scope.html)
>
...
> v0.14 변경(2026-09-01 — 사람 결정): **`nerv_spec_attach` 추가로 19종 → 20종**(§4.2). 디자인 시안을 문서에 매다는 길이 없었다 — 외부 링크는 스펙의 버전과 무관하게 바뀌어 "이 판이 말하는 화면" 을 되짚을 수 없다.
