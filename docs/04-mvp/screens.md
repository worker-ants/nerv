...
>
> 문서 버전 v0.8 · 2026-08-23 · HTML 판: [screens.html](../html/screens.html)
>
...
스펙 목록(`/p/:proj/specs`)에 **트리 / 관계 그래프** 두 탭을 둔다. 별도 라우트로 가르지 않는 이유는 둘이 **같은 질문의 두 답**이기 때문이다 — 계층으로 찾을 때와 관계로 찾을 때. 라우트를 나누면 둘을 오가며 비교할 수 없다.
