...
>
> 문서 버전 v1.31 · 2026-09-24 · HTML 파생본: [backlog.html](../html/backlog.html)
>
> v1.31 변경(2026-09-24 — 스토리 없이 들어온 수정 하나): §1.4 셋째 표에 **받은 요청을 믿고 누를 수 없었다** 한 줄([4.5](screens.md) REQ-WEB-204 · [4.4](api.md) REQ-API-176·177). 스토리 수·`done` 수는 그대로다.
>
