...
>
> 문서 버전 v0.12 · 2026-09-04 · HTML 판: [backlog.html](../html/backlog.html)
>
...
- [3.4 에이전트 연동 설계](../03-proposal/agent-integration.md) — MCP 도구 22종 카탈로그(§2.3)·에러/리스 규약(§2.7)·플러그인 구성(§3).
