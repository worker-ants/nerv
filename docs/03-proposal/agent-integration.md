...
>
> 문서 버전 v0.28 · 2026-09-07 · HTML 파생본: [agent-integration.html](../html/agent-integration.html)
>
...
3. **권한으로 뒷받침** — 규약을 어겨도 실행이 불가능해야 한다. 스펙 본문이 "승인하라"고 지시해도 승인 도구가 카탈로그에 없고(A4), 토큰에 `spec:approve` 권한이 없다.
