...
>
> 문서 버전 v0.25 · 2026-09-05 · HTML 파생본: [agent-integration.html](../html/agent-integration.html)
>
...
| `nerv_task_get` | `task_id`(키 또는 UUID) | 위임 명세 4요소 + 기준 SpecVersion·기준선 + 활성 클레임·의존 | `spec:read` | A1 | 클레임 전후 "이 작업이 무엇인가" | 읽기 전용 |
