...
export const en = {
  ...
  'invite.page_title': 'Organisation invitation',
  'invite.pending': 'Pending',
  'invite.revoke': 'Revoke',
  'invite.revoked': 'Revoked',
  'invite.role': 'Role',
  'invite.scope': 'Scope',
  'invite.scope_org': 'Whole organisation',
  ...
  'onboarding.step1': '① Create an organisation',
  'onboarding.step1_body':
    'You are not in an organisation yet. Create one and you become its admin — projects and members start from there.',
  'onboarding.step1_create': 'Create organisation',
  ...
  'onboarding.step1_org_name': 'Organisation name',
  'onboarding.step1_slug_hint': 'Used in addresses (/o/…) — cannot be changed later',
  'onboarding.step1_wait':
    'If someone already runs an organisation here, ask for an invitation rather than making another — split organisations mean split specs.',
