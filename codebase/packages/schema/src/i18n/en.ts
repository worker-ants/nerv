...
export const en = {
  ...
  'agent.release_before_exit': 'Record status with nerv_task_update, then release with nerv_task_release before exiting.',
  ...
  'export.index_lead': '> NERV spec tree index. Each entry points at the md mirror of the latest approved version.',
  ...
  'mcp.arg.hostname': 'Whose machine this is — one of the three identity fields on the session board',
