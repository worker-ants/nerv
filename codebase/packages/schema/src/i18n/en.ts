...
export const en = {
  ...
  'graph.restore': 'Undo moves',
  'graph.webgl': 'Fast rendering (WebGL)',
  'graph.webgl_hint': 'Turn this off if the graph looks broken. Changing it reloads the page.',
  'graph.webgl_unsupported': 'Not available in this browser.',
