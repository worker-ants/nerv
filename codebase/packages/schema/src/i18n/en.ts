...
export const en = {
  ...
  'spec.lease_taken': 'You took over editing. You can edit now.',
  ...
  'spec.new_draft_hint': "Approved versions can't be edited. This starts the next version",
  'spec.new_draft_started': 'Started new draft v{version}',
  ...
  'specs.new': '+ New spec',
  'specs.new.created': 'Spec created as a draft.',
  'specs.new.dialog': 'New spec',
  'specs.new.key_field': 'Spec key',
  'specs.new.key_hint': 'Stays the same even if the document is moved or renamed',
  'specs.new.lead': 'It starts as a draft. After you request review, a person approves it.',
  ...
  'spec.changed_by_others_body':
    'Saving now will cause a conflict. Check the latest version first.',
  'spec.conflict_body_post': '. Choose what to do below.',
  'spec.conflict_body_pre': 'Changes were saved elsewhere first. Nothing was overwritten, and',
  ...
  'spec.conflict_title': 'Save conflict: the base version changed.',
  ...
  'spec.editor.source_readonly': 'Read-only (edit in the terminal)',
  ...
  'spec.lease_mine': '✏️ Editing · {name} · web · auto-renews every 30 min',
  'spec.lease_mine_anon': 'you',
  'spec.lease_other': '✏️ {name} is editing, so this is now read-only.',
  ...
  'spec.roundtrip_unstable':
    'Saving could change the content, so saving is blocked. Check the source view.',
