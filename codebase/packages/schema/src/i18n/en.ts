...
export const en = {
  ...
  'error.approval.bulk_not_eligible':
    'This approval cannot be decided in bulk — decide it one by one.',
  ...
  'error.auth.not_registered_hint':
    'Adding a member needs an account — send an invitation to someone who has not signed up.',
  ...
  'error.human_only.account':
    'Only a person can change account details — not through an agent token.',
  ...
  'tasks.card_runner': 'An agent is running it — {host} · {agent}',
  ...
  'spec.next.draft':
    'This is a draft — an agent writes it, and when it is ready you request review.',
  'spec.next.in_review': 'In review — the decision happens on the card in the Inbox.',
  'spec.next.approved': 'This is the approved version — turn its promises into tasks.',
  'spec.next.rejected': 'Rejected — an agent fixes it and brings it back as a new draft.',
  'spec.next.superseded': 'This is an older version — a newer approved one exists.',
  'spec.next.no_version': 'A grouping node with no version yet — there is no body to review.',
  'spec.next.blocked': '{count} blocking pre-review findings — fix them first',
  ...
  'spec.comment.lost':
    '{count} with a lost anchor — the heading they pointed at is gone from the body',
  'spec.comment.resolved_show': 'Show {count} resolved',
  'spec.comment.resolved_hide': 'Hide {count} resolved',
  'spec.comment.anchor_pick': 'Pick an anchor — a heading or a requirement',
  ...
  'settings.workspace.default_branch_hint': 'The branch that code-path evidence points at.',
  ...
  'settings.workspace.slug_needed':
    'The name gave no address — write it in lowercase letters and digits.',
  ...
  'state.load_failed': 'Could not load this.',
  'state.render_failed': 'This screen stopped while rendering.',
  'state.not_found': 'There is no screen at this address.',
  ...
  'state.project_not_found_hint':
    'The current organization has no such project. If the address is right, open it in the organization that has it.',
  'state.project_in_org': 'Open in {org}',
  'state.not_member': 'You are not a member of this project — {slug}',
  ...
  'home.greeting_failed': '{name}, your inbox could not be loaded',
  ...
  'task.next.held_by_other': 'Someone else holds it — they or a planner/admin move it',
  'task.next.finish': 'Finish…',
  'task.next.reclaim_hint':
    'An expired lease is attached — claiming reclaims it and takes the task',
  ...
  'task.spec_impact_some': 'Some — which spec, and how',
  'task.spec_impact_choose': 'Choose the spec impact first — "none" is a choice too',
  'task.spec_impact_note_required': 'If there is an impact, write which spec should change and how',
  'task.evidence_none_yet': 'No evidence attached yet — the done gate requires it',
  ...
  'inbox.key.send': 'send from the box · ⇧ rejects',
  ...
  'help.env.init_hint':
    'Run it once in your working repository. The command asks for the token without echoing it — so it stays out of your shell history.',
  'help.env.project': 'Project',
  'help.env.role': 'Your role',
  'help.env.server': 'NERV server address',
  'help.env.title': 'Values for this deployment',
  ...
  'onboarding.step1_first_project_hint':
    'Leave it empty to create one later in Settings → Workspace.',
  'onboarding.step1_project_failed':
    'The organization was created, but the first project was not — {reason}',
  ...
  'settings.tokens.no_project_admin':
    'This organization has no projects, so a token cannot be issued — tokens are bound to a project.',
  'invite.role': 'Role',
  ...
  'inbox.bulk.blocked.gate_bypass': 'This is a gate waiver — decide it one by one.',
  'inbox.bulk.blocked.not_eligible': 'This cannot be approved in bulk.',
  'inbox.bulk.blocked.quorum': 'This needs two approvers — decide it one by one.',
  ...
  'inbox.bulk.confirm_hint':
    'You are deciding without opening the bodies — the list below is all of it.',
  'inbox.bulk.confirm_reject': 'Rejecting {count} items',
  'inbox.bulk.done': 'Decided {n} items.',
  'inbox.bulk.item_failed': 'Not decided — {reason}',
  'inbox.bulk.partial': 'Decided {n}, {failed} left.',
  'inbox.bulk.reason': 'Rejection reason — the same reason is recorded on every item',
  'inbox.bulk.reject': 'Reject selected',
  'inbox.bulk.select_all': 'Everything visible',
  'inbox.bulk.select_card': 'Add to bulk decision',
  'inbox.bulk.selected': '{count} selected',
  'inbox.bulk.skipped': '{count} that cannot be bulk-approved are left out',
  ...
  'home.project.approvals_hint':
    'Every undecided approval in this project — the ones waiting on you are counted under Today',
  ...
  'spec.body_agent_only': 'Agents write the body — use the command in [Continue in the terminal].',
  ...
  'task.reviews.none': 'No review has covered this task.',
  ...
  'task.form.source': 'Source — which approved version is this work from',
  ...
  'task.form.source_hint':
    'With a source set, that requirement’s implementation status follows this task.',
  ...
  'task.form.saved_backlog':
    'Saved — it is in the backlog. Once all four are filled, press [Move to ready].',
  ...
  'tasks.filter.applied': 'Filtered — the numbers and lanes count only matching tasks',
  ...
  'tasks.ready_empty.backlog': 'Fill {count} in backlog',
  ...
  'settings.gates.lead':
    'Here you edit the tier boundaries and dynamic escalation — the "when it cannot decide" values below are read-only.',
  ...
  'account.email': 'Email',
  'account.email_hint': 'It is your sign-in ID, so it is not changed here.',
  ...
  'account.password_mismatch': 'The two new passwords do not match.',
  'account.revoke_others': 'Sign out every other device',
  'account.revoke_others_hint':
    'Leave this on if you think the password leaked — this browser stays signed in.',
  'account.password_submit': 'Change password',
  'account.password_changed': 'Password changed.',
  'account.password_changed_revoked': 'Password changed, and every other device was signed out.',
  ...
  'settings.tokens.expires_hint':
    'An expired token is refused from that moment — same effect as revoking it.',
  ...
  'settings.tokens.no_project':
    'You belong to no project, so nothing can be issued — ask an admin to add you.',
  'settings.tokens.org_empty': 'No tokens issued in this organization.',
  'settings.tokens.org_hint': 'Who holds which token on which project — admins only.',
  ...
  'settings.tokens.project_hint':
    'A token works on the one project you pick — issue a separate token per project.',
  ...
  'settings.tokens.preset_custom': 'Choose myself',
  'settings.tokens.preset_hint':
    'Recommended is what an agent needs for the five skills (next · spec · impl · question · review) — scopes your role lacks are left out.',
  ...
  'settings.tokens.step2_github':
    'The plugin cannot be fetched from this server’s address, so it comes from GitHub — the install chapter says why.',
  ...
  'settings.tokens.step3_note':
    'This line leaves the token in your shell history. To avoid that, drop --token and its value — the token is then asked for with input hidden.',
  ...
  'settings.tokens.human_only_title':
    'A human-only scope — approving and deciding are for people only, so a token cannot have it',
  ...
  'scope.desc.agent-session:launch': 'Open agent sessions — needed to connect',
  ...
  'scope.desc.approval:decide': 'Decide inbox requests',
