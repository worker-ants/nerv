...
export const ko = {
  ...
  'help.env.init': '설정 명령',
  'help.env.init_hint':
    '작업 저장소에서 한 번 돌립니다. 토큰은 명령이 가려서 묻습니다 — 셸 히스토리에 남기지 않으려고요.',
  ...
  'invite.decline_confirm': '이 초대를 거절할까요? 다시 참여하려면 새 초대를 받아야 합니다.',
  ...
  'task.form.saved_backlog':
    '저장했습니다 — backlog 에 있습니다. 네 요소가 다 찼으면 [준비됨으로 올리기]를 누릅니다.',
  'task.form.title': '제목',
