...
export const ko = {
  ...
  'spec.lease_taken': '편집 권한을 넘겨받았습니다. 이제 편집할 수 있습니다.',
  ...
  'spec.new_draft_hint': '승인된 버전은 고칠 수 없습니다. 다음 버전을 새로 시작합니다',
  'spec.new_draft_started': '새 초안 v{version} 을(를) 시작했습니다',
  ...
  'specs.new': '+ 새 스펙',
  'specs.new.created': '스펙을 초안으로 만들었습니다.',
  'specs.new.dialog': '새 스펙',
  'specs.new.key_field': '스펙 키',
  'specs.new.key_hint': '문서 번호입니다. 문서를 옮기거나 이름을 바꿔도 바뀌지 않습니다',
  'specs.new.lead': '초안으로 시작합니다. 검토를 요청하면 사람이 승인합니다.',
  ...
  'error.spec.not_in_review': '검토 중 상태가 아닙니다.',
  ...
  'help.env.init': '설정 명령',
  'help.env.init_hint':
    '작업 저장소에서 한 번 실행합니다. 토큰은 셸 기록에 남지 않도록 명령이 따로 입력받습니다.',
  ...
  'home.no_projects_admin':
    '이 조직에는 아직 프로젝트가 없습니다. 스펙과 작업은 프로젝트 안에서 관리합니다.',
  ...
  'home.lead': '여기 있는 항목만 내 결정이 필요합니다. 나머지는 에이전트가 진행하고 있습니다.',
  ...
  'home.stat.questions_hint': '에이전트가 막혀서 물어본 질문',
  ...
  'inbox.card.self_requested_title': '작업을 지시한 사람은 그 결과를 직접 승인할 수 없습니다',
  ...
  'spec.attachments': '첨부',
  'spec.comments': '코멘트',
  'spec.changed_by_others': '문서를 연 뒤 다른 곳에서 저장됐습니다.',
  'spec.changed_by_others_body': '지금 저장하면 충돌이 납니다. 최신 내용을 먼저 확인하세요.',
  'spec.conflict_body_post': '아래에서 어떻게 할지 고르세요.',
  'spec.conflict_body_pre': '다른 곳에서 먼저 저장된 내용이 있습니다. 덮어쓰지 않았고,',
  'spec.conflict_body_strong': '지금 쓰던 본문도 그대로 남아 있습니다.',
  'spec.conflict_copied': '내 본문을 클립보드에 복사했습니다.',
  'spec.conflict_copy': '내 본문 복사',
  'spec.conflict_reload': '서버의 최신 내용 보기(내 편집은 버림)',
  ...
  'spec.editor.source_readonly': '읽기 전용 (편집은 터미널에서 합니다)',
  ...
  'spec.lease_mine': '✏️ 편집 중 · {name} · 웹 · 30분마다 자동 갱신',
  'spec.lease_mine_anon': '나',
  'spec.lease_other': '✏️ {name} 이(가) 편집하고 있어 읽기 전용으로 전환했습니다.',
  ...
  'spec.roundtrip_unstable':
    '저장하면 내용이 달라질 수 있어 저장을 막았습니다. 소스 보기에서 확인하세요.',
  'spec.saved': '초안을 저장했습니다.',
  'spec.saved_unknown_refs': '초안을 저장했습니다. 아직 없는 참조: {refs}',
  'spec.submit_blocked': '사전 검토에 차단 항목이 있습니다. 표시된 위치를 먼저 고치세요',
  ...
  'spec.editor.empty': '본문이 비어 있습니다. 여기에 내용을 쓰세요.',
