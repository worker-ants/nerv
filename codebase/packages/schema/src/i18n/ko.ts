...
export const ko = {
  ...
  'spec.new_draft_hint': '승인본은 고칠 수 없습니다 — 다음 판을 시작합니다',
  ...
  'specs.new.key_hint': '안정 키입니다 — 링크와 Task 가 이 값을 가리킵니다',
  ...
  'spec.version_current': '현재 판으로',
  'spec.diff.no_previous': '첫 판이라 견줄 앞이 없습니다',
  ...
  'spec.baseline_unpinned': '기준 밖 — 최신 판',
