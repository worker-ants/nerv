...
export const ko = {
  ...
  'error.approval.bulk_not_eligible': '일괄 승인 대상이 아닙니다 — 한 건씩 결정해야 합니다.',
  ...
  'error.auth.not_registered_hint':
    '멤버 추가는 가입한 사람만 받습니다 — 아직 가입하지 않은 사람에게는 초대를 보내세요.',
  ...
  'error.human_only.account':
    '계정 정보는 사람만 바꿀 수 있습니다 — 에이전트 토큰으로는 바꾸지 않습니다.',
  ...
  'home.greeting_clear': '{name}님, 밀린 결정이 없습니다',
  'home.greeting_pending': '{name}님, 결정 {count}건이 밀려 있습니다',
  ...
  'agent.no_claim': 'NERV: 활성 클레임 없음 — /nerv:next 로 시작한다.',
  ...
  'spec.next.draft': '초안입니다 — 에이전트가 쓰고, 준비되면 검토를 요청합니다.',
  'spec.next.in_review': '검토 중입니다 — 결재는 받은 요청의 카드에서 합니다.',
  'spec.next.approved': '승인본입니다 — 이 약속을 작업으로 옮깁니다.',
  'spec.next.rejected': '반려됐습니다 — 에이전트가 고쳐 새 초안으로 다시 올립니다.',
  'spec.next.superseded': '지난 버전입니다 — 더 새 승인본이 있습니다.',
  'spec.next.no_version': '아직 버전이 없는 묶음 노드입니다 — 검토할 본문이 없습니다.',
  'spec.next.blocked': '사전 검토 block {count}건 — 먼저 고칩니다',
  ...
  'spec.comment.lost': '앵커 유실 {count}건 — 가리키던 헤딩이 본문에서 사라졌습니다',
  'spec.comment.resolved_show': '해결된 것 {count}건 보기',
  'spec.comment.resolved_hide': '해결된 것 {count}건 접기',
  'spec.comment.anchor_pick': '앵커 고르기 — 헤딩 또는 요구사항',
  'spec.comment.anchor_headings': '헤딩',
  ...
  'settings.workspace.default_branch': '기준 갈래',
  'settings.workspace.default_branch_hint': '코드 경로 증적이 가리키는 갈래입니다.',
  ...
  'settings.workspace.slug_needed':
    '이름에서 주소를 만들지 못했습니다 — 영문 소문자·숫자로 적어 주세요.',
  ...
  'spec.requirements.empty_draft':
    '요구사항은 승인될 때 본문의 요구사항 줄에서 만들어집니다 — 이 문서는 아직 승인된 적이 없습니다.',
  ...
  'task.blocked.human_only': '서버가 판정할 수 없는 사유입니다 — 사람이 확인하고 풉니다',
  'task.blocked.nothing_pending': '막고 있는 것이 남아 있지 않습니다',
  'task.blocked.satisfied': '이제 풀 수 있습니다',
  'task.blocked.title': '막힘 — 무엇이 되면 풀리는가',
  'task.claim': '클레임',
  ...
  'error.task.claim_required': '이 작업의 살아 있는 클레임이 없습니다 — 먼저 클레임해야 합니다.',
  ...
  'task.next.held_by_other': '다른 사람이 쥐고 있습니다 — 그 사람이나 planner·admin 이 옮깁니다',
  'task.next.finish': '완료…',
  'task.next.reclaim_hint':
    '리스가 지난 클레임이 걸려 있습니다 — 클레임하면 그것을 회수하고 잡습니다',
  'task.next.to_ready': '준비됨으로 올리기',
  'task.next.to_ready_hint': '서버가 위임 명세 4요소와 선행 작업을 확인해 큐에 올립니다',
  ...
  'task.spec_impact_some': '영향 있음 — 어떤 스펙이 어떻게',
  'task.spec_impact_choose': '스펙 영향을 먼저 고르세요 — "없음" 도 고르는 것입니다',
  'task.spec_impact_note_required': '영향이 있으면 어떤 스펙이 어떻게 바뀌어야 하는지 적습니다',
  'task.evidence_none_yet': '아직 붙은 증적이 없습니다 — done 게이트는 증적을 요구합니다',
  'task.mark_blocked': '막힘으로 표시',
  'tasks.to_ready_done': '준비됨으로 올렸습니다 — 에이전트가 가져갈 수 있습니다.',
  'task.form.lead_new':
  ...
  'inbox.card.session_waiting': '세션이 이 결재를 기다림',
  'inbox.card.view_diff': '변경분 보기 ▸',
  'inbox.card.plan_for': '플랜 대상: {key} {title}',
  'inbox.card.finding_of': '발견({severity}): {title}',
  'inbox.key.send': '칸 안에서 보내기 · ⇧ 는 거절',
  'inbox.key.undo': '보내기 전에 무르기',
  'inbox.grace.held': '{what} — {s}초 뒤 보냅니다.',
  ...
  'help.env.init': '설정 명령',
  'help.env.init_hint':
    '작업 저장소에서 한 번 돌립니다. 토큰은 명령이 가려서 묻습니다 — 셸 히스토리에 남기지 않기 위해서입니다.',
  'help.env.project': '프로젝트',
  'help.env.role': '내 역할',
  'help.env.server': 'NERV 서버 주소',
  'help.env.title': '이 배치의 값',
  ...
  'invite.wrong_account':
    '이 초대는 다른 이메일로 왔습니다 — 초대받은 계정으로 로그인해야 수락할 수 있습니다.',
  ...
  'onboarding.step1_first_project_hint': '비워 두면 나중에 설정 → 조직·프로젝트에서 만듭니다.',
  'onboarding.step1_project_failed': '조직은 만들었지만 첫 프로젝트는 만들지 못했습니다 — {reason}',
  'start.title': '시작 체크리스트',
  'start.lead': '새 조직을 쓰기 시작하는 세 걸음입니다. 셋을 마치면 이 카드는 사라집니다.',
  ...
  'home.no_projects_admin':
    '이 조직에는 아직 프로젝트가 없습니다. 스펙과 작업은 프로젝트 안에 쌓입니다.',
  ...
  'settings.workspace.new_org_lead':
    '다른 팀이나 고객사의 일을 따로 두려면 조직을 새로 만듭니다. 만든 사람이 그 조직의 admin 이 됩니다.',
  'settings.tokens.no_project_admin':
    '이 조직에 프로젝트가 없어 발급할 수 없습니다 — 토큰은 프로젝트에 묶입니다.',
  'invite.role': '역할',
  'invite.scope': '적용 범위',
  ...
  'login.invite_note': '초대 링크로 오셨다면 로그인한 뒤 초대 카드에서 [수락]을 누르세요.',
  'login.password': '비밀번호',
  'login.submit': '로그인',
  ...
  'inbox.bulk.blocked.gate_bypass': '게이트 면제 요청입니다 — 한 건씩 결정합니다.',
  'inbox.bulk.blocked.not_eligible': '일괄 승인 대상이 아닙니다.',
  'inbox.bulk.blocked.quorum': '두 사람의 승인이 필요합니다 — 한 건씩 결정합니다.',
  'inbox.bulk.cancel': '취소',
  'inbox.bulk.clear': '선택 해제',
  'inbox.bulk.confirm_approve': '{count}건을 승인합니다',
  'inbox.bulk.confirm_hint': '본문을 열지 않고 결정하는 조작입니다 — 아래 목록이 그 전부입니다.',
  'inbox.bulk.confirm_reject': '{count}건을 거절합니다',
  'inbox.bulk.done': '{n}건 처리했습니다.',
  'inbox.bulk.item_failed': '처리되지 않았습니다 — {reason}',
  'inbox.bulk.partial': '{n}건 처리 · {failed}건이 남았습니다.',
  'inbox.bulk.reason': '거절 사유 — 전 건에 같은 사유가 남습니다',
  'inbox.bulk.reject': '일괄 거절',
  'inbox.bulk.select_all': '보이는 것 전체',
  ...
  'home.project.approvals_hint':
    '이 프로젝트의 결정되지 않은 결재 전체 — 내 차례는 오늘 할 일이 셉니다',
  'home.project.critical': '열린 critical',
  'project.no_sessions_ended_hint': '끝난 세션은 세션 화면에서 봅니다.',
  'project.see_all_sessions': '세션 전체 보기',
  'project.waiting.label': '기다리는 것',
  'project.waiting.none': '지금 이 프로젝트에서 당신을 기다리는 것은 없습니다.',
  ...
  'spec.body_agent_only': '본문은 에이전트가 씁니다 — [터미널에서 이어쓰기]의 명령을 쓰세요.',
  'spec.body_source': '소스',
  ...
  'task.reviews': '리뷰',
  'task.reviews.none': '이 작업을 지난 리뷰가 없습니다.',
  ...
  'task.form.source': '출처 — 어느 승인본에서 나온 일인가',
  'task.form.source_spec': '스펙',
  'task.form.source_version': '버전(승인본만)',
  'task.form.source_requirement': '요구사항(선택)',
  'task.form.source_none': '고르지 않음',
  'task.form.source_locked': '{spec} v{version} 에서 파생합니다',
  'task.form.source_hint': '출처를 고르면 그 요구사항의 구현 상태가 이 작업을 따라 움직입니다.',
  'task.form.new': '새 작업',
  'task.form.priority': '우선순위',
  'task.form.promoted': '위임 명세가 다 차서 준비됨으로 올렸습니다.',
  'task.form.saved_backlog':
    '저장했습니다 — 백로그에 있습니다. 네 요소가 다 찼으면 [준비됨으로 올리기]를 누릅니다.',
  'task.form.title': '제목',
  ...
  'settings.gates.lead':
    '여기서는 티어 경계와 동적 강화를 고칩니다 — 아래 "판정할 수 없을 때" 값은 보기만 합니다.',
  ...
  'account.name': '표시 이름',
  'account.name_hint': '멤버 표·카드·활동에 이 이름이 적힙니다.',
  'account.name_saved': '이름을 바꿨습니다.',
  'account.email': '이메일',
  'account.email_hint': '로그인 아이디라 여기서 바꾸지 않습니다.',
  ...
  'account.revoke_others_hint':
    '비밀번호가 새어 나간 것 같다면 켜 두세요 — 이 브라우저는 그대로 로그인돼 있습니다.',
  ...
  'settings.tokens.expires_hint': '만료된 토큰은 그 순간부터 거절됩니다 — 폐기와 같은 효과입니다.',
  ...
  'settings.tokens.preset_hint':
    '권장은 에이전트가 스킬 다섯(next·spec·impl·question·review)을 쓰는 데 드는 권한입니다 — 역할에 없는 권한은 빠집니다.',
  ...
  'settings.tokens.step2_github':
    '이 서버 주소로는 플러그인을 받을 수 없어 GitHub 에서 받습니다 — 이유는 설치 장에 있습니다.',
  'settings.tokens.step3': '③ 설정 — 작업 저장소에서 한 번 실행합니다(설정 파일 셋을 만듭니다)',
  'settings.tokens.step3_note':
    '이 줄은 토큰을 셸 기록에 남깁니다. 남기지 않으려면 --token 과 그 값을 빼고 실행하세요 — 그러면 토큰을 가려서 묻습니다.',
  'settings.tokens.install_chapter': '설치 장 전체 보기',
  'settings.tokens.waiting': '에이전트가 이 토큰을 처음 쓰면 여기에 "연결됨" 이 뜹니다.',
  ...
  'specs.start.import_how': '가져오는 법',
  'specs.start.ask': '스펙 초안은 {roles} 역할이 씁니다 — 그 사람에게 요청하세요.',
  'specs.start.how': '시작하는 법 ▸',
  ...
  'settings.tokens.lead': '원문은 발급 직후 한 번만 보입니다 — 목록에는 앞자리만 남습니다.',
  ...
  'scope.desc.spec:meta': '스펙의 제목·자리를 바꾸고 보관합니다',
  'scope.desc.task:claim': '작업을 가져가고 내려놓습니다',
  ...
  'scope.desc.import:write': '기존 문서를 이관합니다',
  ...
  'realtime.ws_down_body':
    '목록은 {s}초마다 새로 받습니다. 쓰기는 그대로 됩니다 — 다시 연결되면 보던 화면을 모두 새로 받습니다.',
  ...
  'auth.resent': '보냈습니다 — 메일함(스팸함도)을 확인해 주세요.',
  ...
  'mail.verify.body':
    '{name} 님, 반갑습니다.\n\n아래 주소를 열면 이메일 확인이 끝나고 바로 로그인됩니다.\n{url}\n\n확인하기 전에는 로그인할 수 없습니다 — 주소가 그 사람의 것인지 한 번은 물어야 하기 때문입니다.\n메일이 보이지 않으면 스팸함을 보시고, 그래도 없으면 로그인 화면에서 다시 보낼 수 있습니다.\n\n가입한 적이 없다면 이 메일을 지우면 됩니다 — 계정은 확인 전까지 아무것도 할 수 없습니다.',
  ...
  'graph.hint.read':
    '색은 문서 종류입니다 — 범례가 캔버스 왼쪽 아래에 있습니다 · 크기는 이 문서를 가리키는 문서 수입니다(역참조가 많을수록 큽니다). 지금 그려진 것만 세므로 중심 모드에서는 작아 보일 수 있고, 아주 많이 받는 문서들은 한 크기에서 멈춥니다 · 옅은 사각형은 영역이고, 고른 문서와 그 이웃 밖은 흐려집니다',
