...
- The **first column** of the issued list is the project. Revoked and expired tokens are folded away; [Show revoked and expired] unfolds them. Admins also get an **organization-wide table** below it: who holds which token on which project.
