...
//
// **세지 않는 것**(2026-09-07 명시): 근거 열의 경로가 저장소에 실재하는가 · "남은 것" 이
// 아직 유효한가 · 셋째 표가 완전한가 · 산문의 계수(`6종`·`0019` 같은 수). 그것은 사람이
// 본다 — 이 검사가 초록이라고 표의 **내용**이 참인 것은 아니다. 그 사실을 여기 적어 두지
// 않으면 다음 사람은 초록을 "표가 맞다" 로 읽는다.
//
