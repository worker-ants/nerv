...
const NO_HARDCODED_CONTRACT_LITERALS = [
  ...
  },
  {
    ...
    selector:
      'Literal[value=/^(spec|task|claim|session|approval|question|gate|comment|baseline|import|notification|finding|cr|evidence|review|project|member|token)\\.(draft_created|draft_updated|submitted|rejected|approved|superseded|deprecated|comment_added|commented|meta_updated|archived|restored|recheck_requested|resolved|created|cancelled|ready|claimed|blocked|done|rebrief_required|updated|conflict_warn|conflict_blocked|released|started|stale|complete|steered|requested|answered|bypassed|failopen|applied|opened|added|decided|attachment_added|attachment_removed|revoked|removed)$/]',
    message:
